...
var (
	...
	SendMailFailure       = NewPlutoError(http.StatusForbidden, 2011, "Send mail failed", nil)
	...
	UserDeleted         = NewPlutoError(http.StatusForbidden, 4011, "User already deleted", nil)
